...
export function WindowsIcon({ className = "" }: { className?: string }) {
  return (
    <svg
      ...
      fill="currentColor"
    >
      <path d="M3 5.44 10.8 4.3v7.18H3zm8.8-1.27L21 2.86v8.62h-9.2zM3 12.6h7.8v7.1L3 18.56zm8.8 0H21v8.53l-9.2-1.29z" />
    </svg>
  );
}
...
export function BrowserIcon({ className = "" }: { className?: string }) {
  return (
    ...
    >
      ...
      <circle cx="11.5" cy="5" r=".75" fill="currentColor" stroke="none" />
...
export function BroadcastIcon({ className = "" }: { className?: string }) {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M3 14.5V5.5a2 2 0 0 1 2-2h1.5L14 8v4l-7.5 4.5H5a2 2 0 0 1-2-2Z" />
      <path d="M14 8a5 5 0 0 1 0 4" />
      <path d="M15.5 6a8 8 0 0 1 0 8" />
    </svg>
  );
}
...
export function MemoryIcon({ className = "" }: { className?: string }) {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M7 4.5A2.5 2.5 0 0 1 9.5 2h1A2.5 2.5 0 0 1 13 4.5V5h1.5A2.5 2.5 0 0 1 17 7.5v5a2.5 2.5 0 0 1-2.5 2.5H13v.5A2.5 2.5 0 0 1 10.5 18h-1A2.5 2.5 0 0 1 7 15.5V15H5.5A2.5 2.5 0 0 1 3 12.5v-5A2.5 2.5 0 0 1 5.5 5H7z" />
